...
struct STSPInfo : ModuleInfoBase {
    ...
    static constexpr std::array<Element, 40> Elements{{
		...
		SmallButton{{to_mm<72>(129.44), to_mm<72>(43.84), Center, "Reload Samples", ""}},
		DynamicTextDisplay{{to_mm<72>(143.7), to_mm<72>(90.565), Center, "Screen", ""}},
		GateJackInput4ms{{to_mm<72>(27.2), to_mm<72>(283.45), Center, "Play Trig A", ""}},
		AnalogJackInput4ms{{to_mm<72>(73.91), to_mm<72>(284.01), Center, "1V/Oct A", ""}},
		...
		AnalogJackInput4ms{{to_mm<72>(213.99), to_mm<72>(284.01), Center, "1V/Oct B", ""}},
